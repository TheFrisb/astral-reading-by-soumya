...
class AboutUsSettings(SingletonModel):
    ...
    header_3 = models.CharField(
        ...
        default="A Modern Approach to Ancient Wisdom", blank=True
    )
    ...
    list_item_1 = models.CharField(
        max_length=255, verbose_name="First List Item", default="Holistic Approach", blank=True
    )
    ...
    list_item_2 = models.CharField(
        max_length=255, verbose_name="Second List Item", default="Empowerment Focus", blank=True
    )
    ...
    list_item_3 = models.CharField(
        max_length=255, verbose_name="Third List Item", default="Practical Guidance", blank=True
    )
    ...
    list_item_4 = models.CharField(
        max_length=255, verbose_name="Fourth List Item", default="Continuous Growth", blank=True
    )
    ...
    header_4 = models.CharField(
        ...
        default="Professional Certifications", blank=True
    )
    ...
    card_5_title = models.CharField(
        ...
        default="Vedic Astrology Master Certification", blank=True
    )
    card_5_subtitle = models.TextField(
        verbose_name="Fifth Card Subtitle", default="International Academy of Astrology", blank=True
    )
    ...
    card_6_title = models.CharField(
        ...
        default="Advanced Western Astrology Diploma", blank=True
    )
    card_6_subtitle = models.TextField(
        verbose_name="Sixth Card Subtitle", default="Faculty of Astrological Studies", blank=True
    )
    ...
    card_7_title = models.CharField(
        ...
        default="Relationship Astrology Specialist", blank=True
    )
    card_7_subtitle = models.TextField(
        verbose_name="Seventh Card Subtitle",
        default="American Federation of Astrologers", blank=True
    )
    ...
    card_8_title = models.CharField(
        ...
        default="Psychological Astrology Certification", blank=True
    )
    card_8_subtitle = models.TextField(
        verbose_name="Eighth Card Subtitle",
        default="Centre for Psychological Astrology", blank=True
    )
